...
export class UsersPasswordService implements IUsersPasswordService {
	...
	public async comparePassword(userId: number, password: string): Promise<boolean> {
	...
	private async compare(password: string, salt: string, hash: string): Promise<boolean> {
